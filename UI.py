...
def window_1(games):
    ...
    label = Label(root, text=" ",height=5, font='Arial 20 bold')
    label.grid(column=3, row=4)
    root.geometry('{}x{}+{}+{}'.format(width, height, x, y))  # 大小以及位置
    L1 = Label(root, text="Welcome to MuZero! Here's a list of games:", height=5, font='Arial 20 bold')
